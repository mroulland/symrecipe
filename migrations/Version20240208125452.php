 ...
 */
final class Version20240208125452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD is_favorite TINYINT(1) NOT NULL, DROP ingredients');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD ingredients JSON NOT NULL COMMENT \'(DC2Type:json)\', DROP is_favorite');
    }
}
